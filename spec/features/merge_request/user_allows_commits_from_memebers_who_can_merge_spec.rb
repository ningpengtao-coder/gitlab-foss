...
describe 'create a merge request, allowing commits from members who can merge to the target branch', :js do
  ...
  it 'allows setting possible', :sidekiq_inline_tech_debt do
  ...
  it 'shows a message when one of the projects is private', :sidekiq_inline_tech_debt do
  ...
  it 'shows a message when the source branch is protected', :sidekiq_inline_tech_debt do
