...
describe 'User reverts a merge request', :js do
  ...
  it 'reverts a merge request', :sidekiq_inline_tech_debt do
  ...
  it 'does not revert a merge request that was previously reverted', :sidekiq_inline_tech_debt do
    find("a[href='#modal-revert-commit']").click
  ...
  it 'reverts a merge request in a new merge request', :sidekiq_inline_tech_debt do
    find("a[href='#modal-revert-commit']").click
