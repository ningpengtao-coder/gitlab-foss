...
describe 'Projects > Files > User edits files', :js do
  ...
  context 'when an user does not have write access', :js do
    ...
    it 'inserts a content of a file in a forked project', :sidekiq_inline_tech_debt do
      click_link('.gitignore')
      click_button('Edit')
    ...
    it 'opens the Web IDE in a forked project', :sidekiq_inline_tech_debt do
      click_link('.gitignore')
    ...
    it 'commits an edited file in a forked project', :sidekiq_inline_tech_debt do
      click_link('.gitignore')
      find('.js-edit-blob').click
    ...
    context 'when the user already had a fork of the project', :js do
      ...
      it 'links to the forked project for editing', :sidekiq_inline_tech_debt do
        click_link('.gitignore')
        find('.js-edit-blob').click
