...
describe 'Pipeline Badge' do
  ...
  context 'when the project has a pipeline' do
    ...
    context 'when the pipeline was successful' do
      it 'displays so on the badge', :sidekiq_inline_tech_debt do
        job.success
    ...
    context 'when the pipeline failed' do
      it 'shows displays so on the badge', :sidekiq_inline_tech_debt do
        job.drop
    ...
    context 'when the pipeline is preparing' do
      ...
      it 'displays the preparing badge', :sidekiq_inline_tech_debt do
        job.enqueue
