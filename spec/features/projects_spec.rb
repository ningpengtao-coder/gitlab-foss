...
describe 'Project' do
  ...
  describe 'showing information about source of a project fork' do
    ...
    it 'shows a link to the source project when it is available', :sidekiq_inline_tech_debt do
    ...
    it 'shows the name of the deleted project when the source was deleted', :sidekiq_inline_tech_debt do
      forked_project
    ...
    context 'a fork of a fork' do
      ...
      it 'links to the base project if the source project is removed', :sidekiq_inline_tech_debt do
        fork_of_fork
  ...
  describe 'removal', :js do
    ...
    it 'removes a project', :sidekiq_inline_tech_debt do
