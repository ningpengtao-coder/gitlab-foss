...
describe 'GPG signed commits' do
  ...
  it 'changes from unverified to verified when the user changes his email to match the gpg key', :sidekiq_inline_tech_debt do
  ...
  it 'changes from unverified to verified when the user adds the missing gpg key', :sidekiq_inline_tech_debt do
    ref = GpgHelpers::SIGNED_AND_AUTHORED_SHA
