...
describe Gitlab::HashedStorage::Migrator, :sidekiq, :redis do
  ...
  describe '#bulk_migrate' do
    ...
    it 'has all projects migrated and set as writable', :sidekiq_inline_tech_debt do
  ...
  describe '#bulk_rollback' do
    ...
    it 'has all projects rolledback and set as writable', :sidekiq_inline_tech_debt do
      perform_enqueued_jobs do
        subject.bulk_rollback(start: ids.min, finish: ids.max)
      end
  ...
  describe '#migrate' do
    ...
    it 'migrates project storage', :sidekiq_inline_tech_debt do
      perform_enqueued_jobs do
  ...
  describe '#rollback' do
    ...
    it 'rolls-back project storage', :sidekiq_inline_tech_debt do
      perform_enqueued_jobs do
