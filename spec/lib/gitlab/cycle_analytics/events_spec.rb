...
describe 'cycle analytics events' do
  ...
  describe '#test_events', :sidekiq_inline_tech_debt do
    let(:stage) { :test }
  ...
  describe '#staging_events', :sidekiq_inline_tech_debt do
    let(:stage) { :staging }
    let(:merge_request) { MergeRequest.first }
  ...
  describe '#production_events', :sidekiq_inline_tech_debt do
