...
describe 'cycle analytics events' do
  ...
  describe 'GET /:namespace/:project/cycle_analytics/events/issues' do
    ...
    it 'lists the test events', :sidekiq_inline_tech_debt do
    ...
    it 'lists the staging events', :sidekiq_inline_tech_debt do
    ...
    it 'lists the production events', :sidekiq_inline_tech_debt do
