...
describe API::Commits do
  ...
  describe "POST /projects/:id/repository/commits" do
          ...
          context 'when start_project is provided' do
            context 'when posting to a forked project the user owns' do
              ...
              context 'identified by Integer (id)' do
                ...
                it 'adds a new commit to forked_project and returns a 201', :sidekiq_inline_tech_debt do
              ...
              context 'when branch already exists', :sidekiq_inline_tech_debt do
                before do
    ...
    context 'when committing into a fork as a maintainer' do
      ...
      it 'allows pushing to the source branch of the merge request', :sidekiq_inline_tech_debt do
  ...
  describe 'POST :id/repository/commits/:sha/cherry_pick' do
    ...
    context 'when cherry picking to a fork as a maintainer' do
      ...
      it 'allows access from a maintainer that to the source branch', :sidekiq_inline_tech_debt do
