...
describe Groups::DestroyService do
  ...
  shared_examples 'group destruction' do |async|
    context 'database records', :sidekiq_inline_tech_debt do
      before do
    ...
    context 'mattermost team', :sidekiq_inline_tech_debt do
    ...
    context 'file system', :sidekiq_inline_tech_debt do
