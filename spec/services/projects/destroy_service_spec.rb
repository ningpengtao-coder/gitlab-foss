...
describe Projects::DestroyService do
  ...
  context 'Sidekiq inline' do
    ...
    context 'when has remote mirrors' do
      ...
      it 'destroys them', :sidekiq_inline_tech_debt do
    ...
    context 'when project has exports' do
      ...
      it 'destroys project and export', :sidekiq_inline_tech_debt do
  ...
  context 'with async_execute', :sidekiq_inline_tech_debt do
    let(:async) { true }
