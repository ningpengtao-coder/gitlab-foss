...
describe MergeRequest do
  ...
  describe '#diverged_commits_count' do
    ...
    context 'diverged on fork' do
      ...
      it 'counts commits that are on target branch but not on source branch', :sidekiq_inline_tech_debt do
        expect(subject.diverged_commits_count).to eq(29)
      end
    end
  ...
  describe "#environments_for" do
    ...
    context 'with environments on source project' do
      ...
      it 'selects deployed environments', :sidekiq_inline_tech_debt do
  ...
  context 'state machine transitions' do
    describe '#unlock_mr' do
      ...
      it 'updates merge request head pipeline and sets merge_jid to nil', :sidekiq_inline_tech_debt do
