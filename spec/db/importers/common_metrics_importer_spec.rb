...
describe Importers::PrometheusMetric do
  ...
  it 'Importers::PrometheusMetricEnums.group_titles equals ::PrometheusMetric' do
    expect(Importers::PrometheusMetricEnums.group_titles).to eq(existing_group_titles)
  end
end
