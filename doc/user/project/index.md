...
- [GitLab CI/CD](../../ci/README.md): GitLab's built-in [Continuous Integration, Delivery, and Deployment](https://about.gitlab.com/2016/08/05/continuous-integration-delivery-and-deployment-with-gitlab/) tool
  - [Container Registry](../package_registry/container_registry/index.md): Build and push Docker
...
- [Maven packages](../package_registry/maven_repository/index.md): your private Maven repository in GitLab. **(PREMIUM)**
- [NPM packages](../package_registry/npm_registry/index.md): your private NPM package registry in GitLab. **(PREMIUM)**
