...
1. You avoid using dependencies whose license is not compatible with your project with [License Management reports](../../application_security/license_management/index.md) **(ULTIMATE)**
