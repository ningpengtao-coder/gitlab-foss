...
Now that we have our `Dockerfile` let's build and push it to our [GitLab Container Registry](../../../user/package_registry/container_registry/index.md).
...
You may need to [enable Container Registry](../../../user/package_registry/container_registry/index.md#enable-the-container-registry-for-your-project) to your project to see this tab. You'll find it under your project's **Settings > General > Permissions**.
