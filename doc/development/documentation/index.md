...
Read through the [docs architecture](architecture/index.md) document to learn
how we architecture, build, and deploy the docs site, <https://docs.gitlab.com>, as
well as the assets and libraries available.
