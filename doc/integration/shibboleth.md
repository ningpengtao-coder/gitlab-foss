...
the preferred approach to integrating a Shibboleth authentication system 
with Gitlab 10 and newer is to use Shibboleth's SAML confituration to connect 
to [GitLab's SAML integration](saml.md).

# Deprecated GitLab 9 and older 
