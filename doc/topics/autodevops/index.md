...
| `ADDITIONAL_HOSTS`           | Fully qualified domain names [specified as a list](https://github.com/helm/helm/blob/master/docs/using_helm.md#the-format-and-limitations-of---set) that are added to the ingress hosts.                                      |
