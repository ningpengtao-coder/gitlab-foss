...
NOTE: **Note:** Since file system performance may affect Gitlab's overall performance, we do not recommend using EFS for storage. You may review [relevant documentation](../administration/high_availability/nfs.md#avoid-using-awss-elastic-file-system-efs) for more details.
